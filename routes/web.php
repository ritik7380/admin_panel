...
Route::middleware(['auth', 'role:admin|superadmin'])->prefix('roles')->group(function () {
...
// Permissions — only admin and superadmin
Route::middleware(['auth', 'role:admin'])->prefix('permissions')->group(function () {
