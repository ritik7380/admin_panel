				...
				<div class="row g-0">
					<div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
							<div class="card-body">
                                 <img src="{{ asset('new_asset/assets/images/login-images/forgot-password-cover.svg') }}" class="img-fluid" width="600" alt=""/>
							</div>
						</div>
					</div>
            ...
            <div class="card-body p-sm-5">
                <div class="p-3">
                    <div class="text-center">
                        <img src="{{ asset('new_asset/assets/images/icons/forgot-2.png') }}" width="100" alt="" />
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-white">
                            <i class='bx bx-mail-send me-1'></i>Send
                        </button>
